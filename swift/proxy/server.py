...
class Application(object):
    ...
    def __call__(self, env, start_response):
        """
        ���� proxy server �����ڣ��ϲ� middleware ������������������ proxy server �Ĵ������̡�
        ���շ��ص�ʱ�����õ��� swift.common.swob.Response��
        �� Response �������� start_response ���������� head���������أ�body����
        ...
        try:
            ...
            # ���з��ص�ֵ�У�self.handle_request(req)Ϊһ��Response����ʵ����
            # Response���������� __call__(evn,start_response)
    ...
    def handle_request(self, req):
        ...
        try:
            ...
            try:
                # ����ȷ��controller�����ͣ�����req�����ݷֱ𷵻أ�
                # account controller��container controller ���� object controller��
            ...
            try:
                # ������handler����Ӧcontroller���ж�Ӧ��req�з����ķ�����
                # ��Щ����������GET,HEAD,POST,PUT,DELETE,COPY
            ...
            # ���ﷵ�ص�����Ӧ��req��controller�о����Ĵ����������͵�req�ķ�����
            # ������������֮����handler(req)��ʵ��һ��Response����ʵ����
            # ���ù���Ϊ����get objectΪ������
            # swift.proxy.controllers.ObjectControllerRouter ���ҵ���Ӧ��controller
            # �� BaseObjectController ���ҵ� GET ������GET ����ʹ�� GETorHEAD ����
            # GETorHEAD �������� ReplicatedObjectController �е� _get_or_head_response ����
            # _get_or_head_response ʹ�� swift.proxy.controller.Controller(base.py)�е� GETorHEAD_base ����
            # GETorHEAD_base �е��� GetOrHeadHandler ���е� get_working_response ����
            # get_working_response ��������һ�� Response ����ʵ���������ء�
            # ���� Response ����ʵ���������ﱻ���ص�ֵ��
            return handler(req)
